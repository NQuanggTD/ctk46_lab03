...
export async function createGuestbookEntry(
  ...
  // Tránh cảnh báo tham số chưa dùng khi chỉ cần formData
  void prevState;
  ...
  // Không cho phép gửi trùng lặp (cùng name + message) trong vòng 1 phút.
  ...
  if (hasRecentDuplicate) {
    return {
      success: false,
      errors: {
        message: ["Bạn đã gửi lời nhắn trùng lặp trong vòng 1 phút."],
      },
    };
  }
